...
# Imports adapted for capsule context - assuming relative imports might need adjustment or mocking
# For now, keeping them as is but noting they might need to point to other capsules
...
# Placeholder for external dependencies to make this standalone for now
class Intent:
    @staticmethod
...
class ModelNode:
    def __init__(self, id, capabilities, meta=None):
        self.id = id
        self.capabilities = capabilities
        self.meta = meta or {}

class EmbeddingStore:
    def __init__(self, dim, curv, lr, seed):
        pass
...
class Coordinator:
    ...
    def step(self, session: Session, src: str, candidates: List[str], message: Message, task_tag: str | None = None) -> Envelope:
        ...
        # Simplified routing for capsule isolation
        dst = candidates[0] if candidates else src
