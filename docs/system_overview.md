...
**Version:** ALPHA-20251207-CAPSULE
...
For detailed specifications, see [Capsule Specification](vnes/CAPSULE_SPEC.md).
...
For a full list of capabilities, see [Capabilities](concepts/capabilities.md).
...
For more details, see [VNES Overview](vnes/VNES_OVERVIEW.md).

### 4.2 HVS (Hyperbolic Vector Storage)
The HVS system provides persistent, geometry-aware vector storage that can be attached to models, stacks, trunks, or networks.

For more details, see [HVS Overview](hvs_overview.md).
