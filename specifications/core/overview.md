...
> **Detailed Mechanics:** For a deep dive into the mathematical formulas, distance metrics, and the "Acceptance Gate" logic, please refer to **Geometry Mechanics** (Documentation pending migration).

> **Surreal Numerics:** For details on how infinite priorities and infinitesimal costs are handled within the system, refer to **Surreal Mechanics** (Documentation pending migration).
...
See [AGUA Architecture](../../docs/architecture/concepts/agua.md) for details.
